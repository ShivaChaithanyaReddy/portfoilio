...
export class ProjectsService {
  ...
  loadProjects() {
    ...
    // this.projects.push(project);
     ...
     let project = new ProjectModel('Vehicle Tracker',
      'System which is used to track the current condition and location\n' +
      'of all available vehicles',
      'Real time vehicle tracker, used to display the current condition of the \n' +
       'vehicle at any point of time. User will get all the reading of the vehicle every \n' +
       '3 seconds and also locates the vehicle on the map. Provides a user with well designed\n' +
       'user interface to track his/her vehicle',
